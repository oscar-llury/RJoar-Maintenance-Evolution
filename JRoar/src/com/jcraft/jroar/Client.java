...
abstract class Client {
  ...
  // Mantiene una lista de clientes de un determinado servicio y una variable con la última vez que se añadió uno
  // De esta clase heredan HttpClient,  ShoutClient y UDPBroadcast
